...
void menu(){
    ...
    printf("=================================\n");
    printf("\n");
    printf("Introduce el numero de la opcion que quieras realizar:\n");
}

void jugarPartida(){
    int n_jugadores;
    fflush(stdin);
    printf("Introduce el numero de jugadores entre 2 y 4\n");
    scanf("%d", &n_jugadores);

    while (n_jugadores <=1 || n_jugadores >4){
        fflush(stdin);
        printf("Numero de jugadores erroneo. Entre 2 y 4\n");
        scanf("%d", &n_jugadores);
    }
...
void menuSecundario(){
    printf("Escriba el numero de la opcion que quieras, el 1 o el 2\n");
    printf("[1] Dame carta\n");
    printf("[2] Me planto\n");
}
